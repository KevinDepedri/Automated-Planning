...
public:
  ...
  FillBoxWithSupplyAction() : plansys2::ActionExecutorClient("unload_carrier_position_3", 200ms){
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  node->set_parameter(rclcpp::Parameter("action_name", "unload_carrier_position_3"));

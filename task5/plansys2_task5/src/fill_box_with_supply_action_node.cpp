...
public:
  ...
  FillBoxWithSupplyAction() : plansys2::ActionExecutorClient("fill_box_with_supply", 200ms){
    progress_ = 0.0;
  }
...
private:
  ...
  void do_work()
  {
    if (progress_ < 1.0) {
      ...
      finish(true, 1.0, "Filling box completed");
...
int main(int argc, char ** argv)
{
  ...
  node->set_parameter(rclcpp::Parameter("action_name", "fill_box_with_supply"));
